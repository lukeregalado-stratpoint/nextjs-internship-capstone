    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div
            key={index}
            className="bg-white dark:bg-outer_space-500 rounded-lg border border-french_gray-300 dark:border-payness_gray-400 p-6"
          >
            ...
            <div className="text-sm text-payness_gray-500 dark:text-french_gray-400 mb-2">{metric.unit}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-outer_space-500 rounded-lg border border-french_gray-300 dark:border-payness_gray-400 p-6">
          ...
          <div className="h-64 bg-platinum-800 dark:bg-outer_space-400 rounded-lg flex items-center justify-center">
            <div className="text-center text-payness_gray-500 dark:text-french_gray-400">
