        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-sm text-paynes_gray-500 dark:text-french_gray-400">Main dashboard view</p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-paynes_gray-500 dark:text-french_gray-400">Projects listing page</p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-paynes_gray-500 dark:text-french_gray-400">Project board view</p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-paynes_gray-500 dark:text-french_gray-400">Sign in/up placeholders</p>
            </Link>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <div className="text-sm text-paynes_gray-500 dark:text-french_gray-400 mb-3">{item.tasks} tasks</div>
