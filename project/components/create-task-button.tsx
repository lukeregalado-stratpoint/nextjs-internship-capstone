  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1 shrink-0 rounded-xl border border-lavender-200 dark:border-paynes_gray-400 px-3 py-1.5 text-sm font-medium text-outer_space-500 dark:text-platinum-500 hover:bg-lavender-50 dark:hover:bg-paynes_gray-500/20 transition-colors"
      >
