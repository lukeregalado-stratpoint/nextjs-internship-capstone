...
- Name: board-task-lifecycle.spec.ts >> Task lifecycle >> edit an existing task's title and priority
- Location: e2e\board-task-lifecycle.spec.ts:38:7
...
Locator: getByText('Editable task 1787565371858')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Editable task 1787565371858')
