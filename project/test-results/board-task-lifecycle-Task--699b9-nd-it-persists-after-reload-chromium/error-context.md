...
Locator: getByRole('button', { name: /add task/i }).nth(2).locator('../..').getByText('Draggable task 1787565421459')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /add task/i }).nth(2).locator('../..').getByText('Draggable task 1787565421459')
...
- main:
  ...
  - button "Add task":
    - img
  - button "Select task Write the report 1787565365913 medium":
    - button "Select task Write the report 1787565365913 medium":
      - button "Select task"
      - paragraph: Write the report 1787565365913
      - text: medium
  - button "Select task Editable task 1787565371858 medium":
    - button "Select task Editable task 1787565371858 medium":
      - button "Select task"
      - paragraph: Editable task 1787565371858
      - text: medium
  - button "Select task Deletable task 1787565392650 medium":
    - button "Select task Deletable task 1787565392650 medium":
      - button "Select task"
      - paragraph: Deletable task 1787565392650
      - text: medium
  - button "Select task Batch task 1 1787565399958 medium":
    - button "Select task Batch task 1 1787565399958 medium":
      - button "Select task"
      - paragraph: Batch task 1 1787565399958
      - text: medium
  - button "Add task":
    - img
    - text: Add task
  ...
  - button "Add task":
    - img
  - button "Select task Draggable task 1787565421459 medium":
    - button "Select task Draggable task 1787565421459 medium":
      - button "Select task"
      - paragraph: Draggable task 1787565421459
      - text: medium
  - button "Add task":
    - img
    - text: Add task
  ...
  - button "Add column":
    - img
    - text: Add column
  - status: Draggable item c785887e-e933-4889-ac71-0b550c7cd60a was dropped over droppable area c785887e-e933-4889-ac71-0b550c7cd60a
- alert
```
