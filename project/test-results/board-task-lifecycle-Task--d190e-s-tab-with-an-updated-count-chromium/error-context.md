...
- Name: board-task-lifecycle.spec.ts >> Task lifecycle >> adding a comment shows it in the Comments tab with an updated count
- Location: e2e\board-task-lifecycle.spec.ts:112:7
...
Locator: getByText('Commentable task 1787565452362')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Commentable task 1787565452362')
